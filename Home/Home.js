...
const numberOfDuplicates = 1000;
  ...
  const totalImages = duplicatedImages.length; // Use the length of duplicatedImages

  const animationDuration = 15; // in seconds
  const timeGap = animationDuration / duplicatedImages.length; // time between consecutive images starting their animation
