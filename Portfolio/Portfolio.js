...
function Portfolio() {
  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      ...
      setAnimationClass('animate-in-from-right'); // Updated to right-to-left animation
      
      setTimeout(() => setAnimationClass(''), 1500); // Reset the animation class
    ...
    <section id="portfolio" className="portfolio py-3">
      <div className="outer-container">
        <h3 className="text-center">
          ...
          <button className="lets-talk-btn">Let's talk</button> {/* Added this line */}
        </h3>
